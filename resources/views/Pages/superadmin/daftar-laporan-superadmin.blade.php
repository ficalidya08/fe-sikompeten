...
<div class="bg-white rounded-xl shadow p-6 mb-10">
    <h1 class="text-2xl font-semibold text-[#2B3674]">
        DAFTAR LAPORAN KEGIATAN PENGEMBANGAN KOMPETENSI ASN
    </h1>
    <p class="text-sm text-gray-500 max-w-2xl">
        Daftar laporan kegiatan yang saat ini sedang dalam proses pengajuan.
    </p>
</div>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center gap-3" x-data="{ open: false }">
                                ...
                                <!-- Tombol Balas -->
                                <a href="/form-balasan"
                                   class="bg-[#FFA41B] text-white text-xs px-3 py-1.5 rounded-md hover:bg-[#e69518] transition">
                                    Balas
                                </a>
