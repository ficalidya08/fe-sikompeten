  ...
  <body class="flex h-screen bg-[#F4F5F7] text-gray-800">
    ...
    >
      ...
      <nav class="flex-1 p-4 space-y-2 text-sm">
        ...
        <!-- Daftar Usulan -->
        <a
          href="{{ url('/daftar-usulan-superadmin') }}"
          class="flex items-center gap-3 px-3 py-2 rounded-lg transition
            {{ Request::is('daftar-usulan-superadmin') ? 'bg-[#1C1F4A] text-white' : 'text-gray-600 hover:bg-[#E8EDFF]' }}"
        >
          <img 
            src="{{ Request::is('daftar-usulan-superadmin') ? asset('images/briefcase-white.png') : asset('images/briefcase.png') }}" 
            alt="Briefcase" 
            class="w-5 h-5"
          >
          Daftar Usulan
        ...
        <!-- Laporan Kegiatan -->
        <a
          href="{{ url('/daftar-laporan-superadmin') }}"
          class="flex items-center gap-3 px-3 py-2 rounded-lg transition
            {{ Request::is('daftar-laporan-superadmin','form-balasan','review-balasan','notif-balasan') ? 'bg-[#1C1F4A] text-white' : 'text-gray-600 hover:bg-[#E8EDFF]' }}"
        >
          <img 
            src="{{ Request::is('daftar-laporan-superadmin','form-balasan','review-balasan','notif-balasan') ? asset('images/file-white.png') : asset('images/file.png') }}" 
        ...
        <!-- User Manajemen -->
        <a
          href="{{ url('/user-manajemen') }}"
          class="flex items-center gap-3 px-3 py-2 rounded-lg transition
            {{ Request::is('user-manajemen','edit-user','tambah-user') ? 'bg-[#1C1F4A] text-white' : 'text-gray-600 hover:bg-[#E8EDFF]' }}"
        >
          <img 
            src="{{ Request::is('user-manajemen','edit-user','tambah-user') ? asset('images/User-white.png') : asset('images/user.png') }}" 
            alt="User Manajemen" 
            class="w-5 h-5"
          >
          User Manajemen
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden">
      ...
      >
        ...
        <h1 class="text-[#2B3674] font-bold">SuperAdmin</h1>
        <img
