      ...
      <nav class="flex-1 p-4 space-y-2 text-sm">
        ...
        <a
          ...
          class="flex items-center gap-3 px-3 py-2 rounded-lg transition
            {{ Request::is('dashboard-user') ? 'bg-[#1C1F4A] text-white' : 'text-gray-600 hover:bg-[#E8EDFF]' }}"
        >
          <img 
            src="{{ Request::is('dashboard-user') ? asset('images/grid-white.png') : asset('images/grid.png') }}" 
            alt="Grid" 
            class="w-5 h-5"
          >
          Dashboard
