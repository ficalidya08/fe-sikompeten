...
>
 ...
 <!-- Laporan Kegiatan -->
<a
  href="{{ url('/laporan-kegiatan') }}"
  class="flex items-center gap-3 px-3 py-2 rounded-lg
    {{ Request::is('laporan-kegiatan','detail-laporan', 'form-laporan','review-laporan','notif-laporan','edit-laporan') ? 'bg-[#1C1F4A] text-white' : 'text-gray-600 hover:bg-[#E8EDFF]' }}"
>
  <img 
    src="{{ Request::is('laporan-kegiatan', 'detail-laporan','form-laporan','review-laporan','notif-laporan','edit-laporan') ? asset('images/file-white.png') : asset('images/file.png') }}" 
    alt="File" 
    class="w-5 h-5"
  >
  Laporan Kegiatan
